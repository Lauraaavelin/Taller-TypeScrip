...
// tuve errores con la importacion asi la tenia pero no funcionó
//import{series} from './datosSeries.js' por alguna razon no funcionó
// asi que lo hice directamente aqui
const series:Serie[]= [
...
function totalTemporadas(series: Serie[]):number{
    ...
    const pormedio = total/series.length;
    return pormedio;
}
